...
echo   - data\ollama    ^(Pulled LLM models — tens of GB; re-downloading them takes a while^)
echo.
echo Your images in IMAGETALK_ROOT are NOT touched.
echo The next install will re-pull all models and the next start will initialize
echo empty stores; you will need to resync the folders with your collection from scratch.
echo.
...
if exist "data\ollama" rmdir /s /q "data\ollama"
